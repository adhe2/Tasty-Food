            ...
            (Ce.refresh = function (e, t, r, n) {
              if ((!Ke && Ce.enabled) || t)
                if (ae && e && st) wb(ScrollTrigger, "scrollEnd", Ob);
                  ...
                  !rt && Se && Se(Ce), (Ke = Ce), A.tween && !r && (A.tween.kill(), (A.tween = 0)), ee && ee.pause(), le && O && O.revert({ kill: !1 }).invalidate(), Ce.isReverted || Ce.revert(!0, !0), (Ce._subPinOffset = !1);
                  var i,
                    o,
                    a,
                    s,
                  ...
                  p &&
                    ...
                    (x || Oe !== Ce.progress || de || le || (O && !O._initted)) && (O && !ve && O.totalProgress(de && R < -0.001 && !Oe ? He.utils.normalize(R, L, 0) : Oe, !0), (Ce.progress = x || (D - R) / N === Oe ? 0 : Oe)),
                  ...
                  if (
                    ...
                    ve ||
                      (!ee || Ke || ot
                        ...
                        : (ee._dp._time - ee._start !== ee._time && ee.render(ee._dp._time - ee._start), ee.resetTo ? ee.resetTo("totalProgress", d, O._tTime / O._tDur) : ((ee.vars.totalProgress = d), ee.invalidate().restart()))),
                    ae)
                  )
